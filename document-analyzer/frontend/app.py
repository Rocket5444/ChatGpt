...
st.header("Extraction Verification")
    ...
    if not selected_file:
        ...
        try:
            ...
            if extraction_type == "Text":
                ...
                st.write(f"Character Count: {payload.get('char_count', 0)}")
                st.text_area("Extracted Text (first 1000 chars)", payload.get("text_preview", ""), height=300)
